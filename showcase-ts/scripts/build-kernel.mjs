...
const source = join(projectRoot, "kernels", "particles.tach");
...
await Promise.all([
  access(join(projectRoot, "build", "particles.js"), constants.R_OK),
  access(join(projectRoot, "build", "particles.d.ts"), constants.R_OK),
]);
