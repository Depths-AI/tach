...
// Pine's portable host ABI intentionally uses one layout for every host-visible
...
func of(t *types.Type, seen map[string]bool) (TypeLayout, error) {
	...
	case types.Bool:
		return TypeLayout{}, fmt.Errorf("bool is a control/value type and is not part of Pine's host ABI")
	case types.Vector:
