...
// by every Pine backend and generated host binding.
package abi
...
// backend-neutral.
func KernelEntry(name string) string { return "__pine_k_" + Mangle(name) }

// Mangle maps a Pine identifier to a conservative ASCII identifier. Pine source
